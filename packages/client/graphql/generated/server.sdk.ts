...
export type MostPopularQuery = { mostPopular: Array<{ id: string, slug?: string | null, clickCount: number, originalUrl: string, createdById?: string | null }> };
 ...
 * });
 */
export function useMostPopularQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<MostPopularQuery, MostPopularQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<MostPopularQuery, MostPopularQueryVariables>(MostPopularDocument, options);
      }
export function useMostPopularLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<MostPopularQuery, MostPopularQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<MostPopularQuery, MostPopularQueryVariables>(MostPopularDocument, options);
        }
export function useMostPopularSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<MostPopularQuery, MostPopularQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
...
export function useCountSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<CountQuery, CountQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useCountClicksQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CountClicksQuery, CountClicksQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<CountClicksQuery, CountClicksQueryVariables>(CountClicksDocument, options);
      }
export function useCountClicksLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CountClicksQuery, CountClicksQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<CountClicksQuery, CountClicksQueryVariables>(CountClicksDocument, options);
        }
export function useCountClicksSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<CountClicksQuery, CountClicksQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
